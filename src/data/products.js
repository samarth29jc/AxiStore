const products = [
 ...
 "https://i.pinimg.com/736x/74/33/4f/74334f4ef8d8f05a1b0fd0ecbf89b5b4.jpg",
  ...
  },
  {
    ...
    images: ["/images/products/slim-chinos-1.jpg", "/images/products/slim-chinos-2.jpg"],
    rating: 4.2,
    reviewCount: 180,
    inStock: true,
    isNew: false,
  ...
  },
  {
    ...
    images: ["/images/products/floral-dress-1.jpg", "/images/products/floral-dress-2.jpg"],
    rating: 4.8,
    reviewCount: 322,
    inStock: true,
    isNew: true,
  ...
  {id :21,
    ...
    images: ["/images/products/graphic-hoodie-1.jpg", "/images/products/graphic-hoodie-2.jpg"],
    rating: 4.4,
    reviewCount: 210,
    inStock: true,
    isNew: false,
  ...
  {id :22,
    ...
    images: ["/images/products/chelsea-boots-1.jpg", "/images/products/chelsea-boots-2.jpg"],
    rating: 4.7,
    reviewCount: 157,
    inStock: true,
    isNew: false,
  ...
  },
  {
    ...
    images: ["/images/products/striped-crop-top-1.jpg", "/images/products/striped-crop-top-2.jpg"],
    rating: 4.3,
    reviewCount: 89,
    inStock: true,
    isNew: true,
