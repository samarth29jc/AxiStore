                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white border rounded-lg overflow-hidden shadow-sm">
                      <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden">
                        <img
                          src="https://images.pexels.com/photos/5698853/pexels-photo-5698853.jpeg?auto=compress&cs=tinysrgb&w=800"
                          alt="Classic Cotton T-Shirt"
                          className="w-full h-64 object-cover"
                        />
                      </div>
                      <div className="p-4">
                        <h3 className="text-base font-medium text-gray-800 mb-1">Classic Cotton T-Shirt</h3>
                        <p className="text-gray-600 mb-3">$19.99</p>
                        <div className="flex space-x-2">
                          <button className="flex-1 btn-primary text-sm py-2">
                            Add to Cart
                          </button>
                          <button className="p-2 text-red-600 bg-white border border-gray-300 rounded-md hover:bg-red-50">
                    ...
                    <div className="bg-white border rounded-lg overflow-hidden shadow-sm">
                      ...
                      <div className="p-4">
                        <h3 className="text-base font-medium text-gray-800 mb-1">Cashmere Sweater</h3>
                        <p className="text-gray-600 mb-3">$119.99</p>
                        <div className="flex space-x-2">
                          <button className="flex-1 btn-primary text-sm py-2">
                            Add to Cart
                          </button>
