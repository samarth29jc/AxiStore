...
function CartPage() {
  ...
  return (
    <div className="pt-24 pb-16 min-h-[60vh] bg-gray-50"> {/* Offset for fixed header, subtle bg */}
        ...
        {cart.length === 0 ? (
          <div className="flex flex-col items-center justify-center min-h-[40vh] py-12">
            <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8 flex flex-col items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-24 h-24 text-gray-300 mb-6">
